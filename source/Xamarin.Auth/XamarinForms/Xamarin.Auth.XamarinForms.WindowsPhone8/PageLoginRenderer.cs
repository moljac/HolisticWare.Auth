...
[assembly: 
	Xamarin.Forms.ExportRenderer
			...
			typeof(Xamarin.Auth.XamarinForms.Authentication.WindowsPhone.PageLoginRenderer)
			)
]
	...
	public partial class PageLoginRenderer : global::Xamarin.Forms.Platform.WinPhone.PageRenderer
	{
		...
		public void Login()
		{
			...
			if (!IsShown)
			{
				...
				// TODO: polymorfic
				OAuth1 oauth1 = this.OAuth as HolisticWare.Auth.OAuth1;
				OAuth2 oauth2 = this.OAuth as HolisticWare.Auth.OAuth2;

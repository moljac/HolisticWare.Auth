...
namespace Xamarin.Auth.XamarinForms
{
	...
	public partial class PageLogin : ContentPage
	{
		...
		/// OAuth
		/// </summary>
		public Xamarin.Auth.XamarinForms.Helpers.OAuth OAuth
		{
			get
			{
				return oauth;
		...
		private Xamarin.Auth.XamarinForms.Helpers.OAuth oauth;
		...
		public PageLogin 
				...
				: this()
		{
			this.OAuth = new Xamarin.Auth.XamarinForms.Helpers.OAuth2()
			{
		...
		public PageLogin (Xamarin.Auth.XamarinForms.Helpers.OAuth2 oauth2)
			: this
					(
		...
		public PageLogin 
				...
				: this()
		{
			this.OAuth =  new Xamarin.Auth.XamarinForms.Helpers.OAuth1()
			{
				OAuth_IdApplication_IdAPI_KeyAPI_IdClient_IdCustomer = application_id_aka_client_id,
		...
		public PageLogin (Xamarin.Auth.XamarinForms.Helpers.OAuth1 oauth1)
			: this
					(
